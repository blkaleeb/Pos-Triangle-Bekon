    ...
    <div class="form-group mb-0">
        ...
        <div class="input-group">
            ...
            <input wire:keydown.escape="resetQuery" wire:model.live.debounce.500ms="query" type="text"
                class="form-control" placeholder="Type supplier name...." wire:model="supplier_name" required>
            <input hidden name="supplier_id" id="supplier_id" value="{{ $selected ? $selected['id'] : '' }}" required>
        </div>
    </div>
                    ...
                    <ul class="list-group list-group-flush">
                        @foreach ($search_results as $result)
                            <li class="list-group-item list-group-item-action">
                                <a wire:click="resetQuery" wire:click.prevent="selectSupplier({{ $result }})"
                                    href="#">
