                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="amount" type="text" class="form-control" name="amount"
                                                required value="{{ old('amount') ?? $saleReturnPayment->amount }}">
                                    ...
                                    <div class="from-group">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="payment_method" id="payment_method" required>
                                                <option {{ $saleReturnPayment->payment_method == 'Cash' ? 'selected' : '' }}
                                                    value="Cash">Cash</option>
                                                <option
                                                    {{ $saleReturnPayment->payment_method == 'Credit Card' ? 'selected' : '' }}
                                                ...
                                                <option
                                                    {{ $saleReturnPayment->payment_method == 'QRIS' ? 'selected' : '' }}
